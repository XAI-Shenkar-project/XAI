...
if MODEL == 'ResNet':
    G_directed_path = "graphs\\ResNet_G_directed.graphml"
elif MODEL == 'VGG':
    G_directed_path = "graphs\\VGG_G_directed.graphml"
elif MODEL == 'GoogLeNet':
    G_directed_path = "graphs\\GoogLeNet_G_directed.graphml"
elif MODEL == 'EfficientNet':
    G_directed_path = "graphs\\EfficientNet_G_directed.graphml"
elif MODEL == 'NASNetLarge':
    G_directed_path = "graphs\\NASNetLarge_G_directed.graphml"
elif MODEL == 'MobileNetV2':
    G_directed_path = "graphs\\MobileNetV2_G_directed.graphml"
...
if os.path.isdir(G_directed_path):
    G = nx.read_graphml(G_directed_path)
else:
    ...
    if MODEL == 'ResNet':
        nx.write_graphml(G, 'ResNet_G_directed.graphml')
    elif MODEL == 'VGG':
        nx.write_graphml(G, 'VGG_G_directed.graphml')
    elif MODEL == 'GoogLeNet':
        nx.write_graphml(G, 'GoogLeNet_G_directed.graphml')
    elif MODEL == 'EfficientNet':
        nx.write_graphml(G, 'EfficientNet_G_directed.graphml')
    elif MODEL == 'NASNetLarge':
        nx.write_graphml(G, 'NASNetLarge_G_directed.graphml')
    elif MODEL == 'MobileNetV2':
        nx.write_graphml(G, 'MobileNetV2_G_directed.graphml')
...
def shortest_distance_matrix(i, j):
    return components_percentages_matrix[i][j]
...
for group in groups:
    if percentages <= 100:
        ...
        components = list(nx.strongly_connected_components(hierarchical_graph))
